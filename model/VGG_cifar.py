...
__all__ = ['VGG', 'cvgg11_bn', 'cvgg13_bn', 'cvgg16_bn', 'cvgg19_bn', 'cvgg8_bn', 'cvgg8_bn_v1']
...
cfg = {
    ...
    'E': [64, 64, 'M', 128, 128, 'M', 256, 256, 256, 256, 'M', 512, 512, 512, 512, 'M',
          512, 512, 512, 512, 'M'],
    'F': [64, 64, 'M', 128, 'M', 256, 'M', 512, 'M', 512, 512, 512, 'M'],
    'F_v1': [64, 64, 'M', 128, 128, 'M', 256, 'M', 512, 512, 'M', 512, 'M'],
}
...
# our保留的层为: (0, 1) (2, 4, 8) (10, 11, 12)
def cvgg8_bn(num_classes, batch_norm=False):  # gai-final
    return VGG(make_layers(cfg['F'], batch_norm=batch_norm), num_classes=num_classes)

# our保留的层为: (0, 1) (2, 3) (4, 7, 9) (12)
def cvgg8_bn_v1(num_classes, batch_norm=False):  # gai-final
    return VGG(make_layers(cfg['F_v1'], batch_norm=batch_norm), num_classes=num_classes)
